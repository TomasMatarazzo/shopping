...
const ProductCart = ({ key, product, eliminarDelCarro, agregarAlCarro }) => {
  ...
  <StyledProductCart>
    ...
    <div className = "data">
      ...
      <Flex>
        <StyledButton onClick = {() => eliminarDelCarro(id)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path d="M0 10h24v4h-24z"></path></svg></StyledButton>
